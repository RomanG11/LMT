...
// contract LMTTokenWrapper {
//   using SafeMath for uint256;
//   IERC20 public lmt;

//   constructor(IERC20 _lmtAddress) public {
...
//   //   lmt.transferFrom(msg.sender, address(this), amount);
//   // }

//   function stakeFor(address userAddress, uint256 amount) virtual public {
//     _totalSupply = _totalSupply.add(amount);
...
//     lmt.transfer(msg.sender, amount);
//   }
// }

// contract GenesisPool is LMTTokenWrapper, Ownable {
...
//     IERC20 _lmtAddress,
//     uint _firstUnlockDate,
//     uint _secondUnlockDate
//     ) public LMTTokenWrapper(_lmtAddress)
//   {
//     nft = _nftAddress;
...
//   function stakeFor(address userAddress, uint256 amount) override public updateReward(userAddress) {
//     locked[userAddress] = locked[userAddress].add(amount);
//     super.stakeFor(userAddress, amount);
...
//     uint availableBalance = balanceOf(msg.sender);
    
//     if(block.timestamp < firstUnlockDate) {
//       availableBalance = availableBalance.sub(locked[msg.sender]);
//     } else if(block.timestamp < secondUnlockDate) {
//       availableBalance = availableBalance.sub(locked[msg.sender] / 2);
//     }
...
//     require(nft.totalSupply(card) < nft.maxSupply(card), "Max cards minted");
